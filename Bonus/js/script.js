...
// ---------------------BONUS---------------------
//chiediamo all'utente il tipo di difficolta del gioco
var difficoltà = parseInt(prompt("scegli una difficolta fra 0 e 2"))

// con lo switch andiamo a farci restitutire una var in base alla difficolta inserita!
switch (difficoltà) {
    case 2:
    var diff = 100 - 16;
    break;
...
function start() {
    while (listUserNumb.length < diff) {
